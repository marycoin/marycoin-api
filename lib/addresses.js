...
AddressController.prototype.validate = function(req, res) {
  res.jsonp(bitcore.Address.isValid(req.param('addr')));
}
...
AddressController.prototype.transformUtxo = function(utxoArg) {
  ...
  if (utxoArg.height && utxoArg.height > 0) {
    ...
    utxo.confirmations = this.node.services.marycoind.height - utxoArg.height + 1;
  } else {
